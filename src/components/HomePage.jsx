...
const HomePage = () => {
  ...
  return (
    <>
    <section className="bg-bg-pattern bg-cover bg-no-repeat bg-center bg-blend-overlay bg-fixed bg-black/40">
     ...
     <div className='h-screen flex items-center justify-center'>
        <div className="text-center mx-auto flex flex-col items-center gap-8 md:gap-10">
                ...
                <a href="" className="px-8 py-2 inline-block bg-primary text-white font-light md:text-xl text-2xl rounded-lg hover:bg-transparent hover:border-2 hover:border-black">Get Started</a>
        </div>
    </div>
